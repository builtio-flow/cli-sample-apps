...
module.exports = {
	name: "subtask_modified",
	label: "Subtask Modified",
	version: "v4",
	input: {
		type: "object",
	...
	mock_data: {
		"event_type": "Subtask Modified",
		"id": 1632161,
		"type": "subtask",
		"title": "Add input fields",
		"previous_title": "Old subtask",
		"version": 1,
		"revision": 2,
		"user_id": 876155,
		...
		"list_url": "https://www.wunderlist.com/#/lists/367230"
	...
	execute: function(input, payload, output) {
		...
		if (!payload || (payload.operation && payload.operation !== "update") || (payload.subject && payload.subject.type !== "subtask") || (payload.data && !payload.data.title) || (input.wunderlist_tasks && input.wunderlist_tasks != payload.after.task_id)) {
			return output(null, []);
		}
		Promise.all([
