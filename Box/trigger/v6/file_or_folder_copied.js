...
var Event = {
  "file": ["FILE.COPIED"],
  "folder": ["FOLDER.COPIED", "FILE.COPIED"]
};

module.exports = {

  name: "file_or_folder_copied",

  label: "File or Folder Copied",

  version: "v6",

  input: {
    "type": "object",
    "title": "File or Folder Copied",
    "description": "Short description",
    "properties": {
      "event": {
        "type": "string",
        "enum": [
          "file_or_folder_copied"
        ]
      },
      "polling": {
        "type": "boolean",
  ...
  try {
    ...
    if (data.source) {
      ...
      if (data.source.parent) {
        ...
        data = _.assign(data, formatData("parent_source", data.source.parent));
      }
      if (data.destination) {
    ...
    data = Object.assign({ "event_type": "File or Folder Copied" }, data)
