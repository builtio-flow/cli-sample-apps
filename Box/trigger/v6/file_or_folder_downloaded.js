...
var Event = {
  ...
  "folder": ["FOLDER.DOWNLOADED", "FILE.DOWNLOADED"]
};

module.exports = {

  name: "file_or_folder_downloaded",

  label: "File or Folder Downloaded",

  version: "v6",

  input: {
    "type": "object",
    "title": "File or Folder Downloaded",
    "description": "Short description",
    "properties": {
      "event": {
        "type": "string",
        "enum": ["file_or_folder_downloaded"]
      },
      "polling": {
        "type": "boolean",
        "default": false,
...
function _output(input, data) {
  try {
    ...
    data = Object.assign({ "event_type": "File or Folder Downloaded" }, data)
