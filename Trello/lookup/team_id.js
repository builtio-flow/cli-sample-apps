...
module.exports = {
	...
	'execute': function (input, options, output) {
		var qs = {}
		var baseURL = "https://api.trello.com/1/members/me/organizations?filter=all&fields=name,displayName"
		var flag = false
		if (!lodash.isEmpty(input.search)) {
			baseURL = "https://trello.com/1/search?query=" + (input.search) + "&partial=" + true + "&modelTypes=organizations&idOrganizations=mine&organizations_limit=" + 1000
			flag = true
		}
