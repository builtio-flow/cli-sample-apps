...
module.exports = {
  ...
  input: {
    ...
    properties: {
      "board_id": {
        ...
        "type": "string",
        "propertyOrder": 2,
        "description": "Select/specify the ID of the board of which card you want to unarchive"
      },
      "list_id": {
        "title": "List ID",
        "description": "Select/specify the ID of the list of which card you want to unarchive",
        "type": "string",
        "propertyOrder": 3,
        "minLength": 1
      },
      "card_id": {
        ...
        "description": "Select/specify the ID of the card you want to unarchive",
        "type": "string",
        "propertyOrder": 4,
        "minLength": 1
      }
  ...
  execute: function (input, output) {
    ...
    var option = {
      url: "https://api.trello.com/1/cards/" + input.card_id + "/closed",
      qs: {
        key: input.auth.key,
