...
module.exports = {
  ...
  input: {
    ...
    properties: {
      "board_id": {
        ...
        "type": "string",
        "propertyOrder": 2,
        "description": "Select/specify the ID of the board of which card you want to rename"
      },
      "list_id": {
        "title": "List ID",
        "description": "Select/specify the ID of the list of which card you want to rename",
        "type": "string",
        "propertyOrder": 3,
        "minLength": 1
      },
      "card_id": {
        "title": "Card ID",
        "description": "Select/specify the ID of the card you want to rename",
        "type": "string",
        "propertyOrder": 4,
        "minLength": 1
      },
      "name": {
        ...
        "type": "string",
        "propertyOrder": 5,
        "description": "Enter the new name of the card",
        "minLength": 1
      },
    }
  },
  ...
  execute: function (input, output) {
    ...
    .then((data)=>{
      ...
      oldURL=data.url
      var optionRename = {
        url: "https://api.trello.com/1/cards/" + input.card_id + "/name",
        qs: {
          key: input.auth.key,
          token: input.auth.access_token,
          value: input.name
    ...
    .then((body)=>{
      ...
      dataCard["old_name"]=oldName
      dataCard["old_card_url"]=oldURL
