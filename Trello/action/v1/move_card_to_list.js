...
module.exports = {
  ...
  input:{
    ...
    properties: {
      "board_id": {
        ...
        "type": "string",
        "propertyOrder": 3,
        "description": "Select/specify the ID of the board of which card you want to move"
      },
      "list_id": {
        "title": "Source List ID",
        "description": "Select/specify the ID of the list of which card you want to move",
        "type": "string",
        "propertyOrder": 4,
        "minLength": 1
      },
      "card_id": {
        "title": "Card ID",
        "description": "Select/specify the ID of the card you want to move",
        "type": "string",
        "propertyOrder": 4,
        "minLength": 1
      },
      "new_list_id": {
        ...
        "description": "Select/specify the ID of the list to which card you want to move",
        "type": "string",
        "propertyOrder": 4,
        "minLength": 1
      },
  ...
  execute: function (input, output) {
    ...
    inputValidation(input, 'new_list_id', output);

    var option = {
      url: "https://api.trello.com/1/cards/" + input.card_id + "/idList",
      qs: {
        key: input.auth.key,
        token: input.auth.access_token,
        value: input.new_list_id
      },
      method: "PUT",
    ...
    .then((body)=>{
      ...
      if(dataBoard && dataBoard.name){
        dataCard["board_id"]=dataBoard.idBoard || dataBoard.id
