...
module.exports = {
  ...
  input: {
    ...
    properties: {
      board_id: {
        ...
        "type": "string",
        "propertyOrder": 2,
        "description": "Select/specify the ID of the board of which card you want to delete"
      },
      "list_id": {
        "title": "List ID",
        "description": "Select/specify the ID of the list of which card you want to delete",
        "type": "string",
        "propertyOrder": 3,
        "minLength": 1
      },
      "card_id": {
        "title": "Card ID",
        "description": "Select/specify the ID of the card you want to delete",
        "type": "string",
        "propertyOrder": 4,
        "minLength": 1
      }
  ...
  execute: function (input, output) {
    ...
    requestCall(option)
      ...
      }).spread((cardDetatils, dataList, dataBoard) => {
