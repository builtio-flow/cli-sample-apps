...
const { getAuthToken } = require("../commons")
	...
	"execute": function (input, options, output) {
		...
		try {
			...
			(async function () {
				...
				let option = {
					url: "https://api.contentstack.io/v3/environments?include_count=false",
					qs: {
						limit: 11,
						skip: pageId * 10,
					},
				...
				request(option, function (e, r, b) {
					...
					if (r.statusCode === 404) return output("Not Found. Please enter the appropriate Env. ID.")
